...
<script>
import Test from '@/components/DataFlowTest.vue'
export default {
    components:{
        Test
    },
    data() {
        return {
            ...
            { "key":80, "header": "Supplier", "isGroup": "true", "role": "b" },
            {"key":81, "type":"Export", "name":"File", "role":"b",  "group": 80},
            ],
            "linkDataArray": [
